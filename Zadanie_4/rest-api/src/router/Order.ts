...
import { createOrder, getAllOrders, getOrderById, getOrdersByStatusId, getOrdersByProductId, getOrdersByUserId, updateOrderById, deleteOrderById, updateOrderStateById, confirmOrderByOrderId } from '../controllers/Order';
...
export default(router : express.Router) => {
    ...
    router.put('/orders/:orderId/confirm', authenticate, checkRolesPermission(new Array(UserRole.STAFF)), confirmOrderByOrderId);
